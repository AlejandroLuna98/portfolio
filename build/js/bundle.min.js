function darkMode() {
  const e = document.querySelector("#switch");
  e.addEventListener("click", () => {
    document.body.classList.toggle("dark"), e.classList.toggle("active");
  });
}
function scrollNav() {
 ...
 * https://modernizr.com/download/?-webp-setclasses !*/ document.addEventListener(
  "DOMContentLoaded",
  () => {
    darkMode(), scrollNav();
  }
  ...
  (function (e, n, A) {
    ...
    function t(e) {
      var n = u.className,
        A = l._config.classPrefix || "";
      if ((f && (n = n.baseVal), l._config.enableJSClass)) {
        var o = new RegExp("(^|\\s)" + A + "no-js(\\s|$)");
        n = n.replace(o, "$1" + A + "js$2");
      }
      l._config.enableClasses &&
        ((n += " " + A + e.join(" " + A)),
        f ? (u.className.baseVal = n) : (u.className = n));
    }
    function a(e, n) {
      if ("object" == typeof e) for (var A in e) c(e, A) && a(A, e[A]);
      else {
      ...
      l.addAsyncTest(function () {
        function e(e, n, A) {
          function o(n) {
            ...
            a(e, "webp" === e && o ? new Boolean(o) : o), A && A(n);
          }
          var t = new Image();
